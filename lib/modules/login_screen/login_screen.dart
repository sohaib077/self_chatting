...
class _LoginScreenState extends State<LoginScreen> {
      ...
      listener: (context, state) {
        if (state is LoginErrorState) {
          if (state.error.contains('The email address is badly formatted'))
            ...
            showToast(
                text:
                    'User not found, make sure you\'ve entered the correct email.',
                state: ToastStates.ERROR);
          else if (state.error.contains(
            ...
            showToast(
                text: state.error.substring(state.error.indexOf(']') + 1),
                state: ToastStates.ERROR);
              ...
              body: Stack(children: [
                Container(
                  padding: EdgeInsetsDirectional.only(
                      top: screenHeight * 0.17, start: screenWidth * 0.07),
                  child: Text(
                    // 'Welcome\n  B a c k',
                    'Welcome',
                    style: TextStyle(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: MaterialButton(
                                          ...
                                          // elevation: 0,
                                          highlightColor:
                                              defaultPurple.withOpacity(0.85),
  ...
  static String checkIfExist(
      String email, String password, List<Map> database) {
    // bool exist = false ;
